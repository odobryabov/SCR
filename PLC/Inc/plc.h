...
#define READY_ON					HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, 	GPIO_PIN_SET)			/* Rdy */
#define READY_OFF					HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, 	GPIO_PIN_RESET)			/* Rdy */
...
#define RESET_SIFU_ON				HAL_GPIO_WritePin(GPIOD, GPIO_PIN_0, 	GPIO_PIN_SET)			/* Res */
#define RESET_SIFU_OFF				HAL_GPIO_WritePin(GPIOD, GPIO_PIN_0, 	GPIO_PIN_RESET)			/* Res */
#define ALLOW_ON					HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, 	GPIO_PIN_SET)			/* LedVkl */
#define ALLOW_OFF					HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2, 	GPIO_PIN_RESET)			/* LedVkl */
...
#define COM_SWITCH_ON				!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_7)							/* SA1 */
#define POWER_SWITCH_ON				!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_8)							/* QF1 */
#define UZP_READY					!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_9)							/* QF2 */
#define LOAD_SWITCH_ON				!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_10)							/* QF9 */
#define THYRISTOR_OVERHEAD			 HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_11)							/* Tyr */
#define TRANSFORMER_OVERHEAD		 HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_12)							/* Trans */
#define VENTILATION_CTRL			!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_13)							/* Izol */
#define SUPPLY_220					!HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_14)							/* P24V */
#define I_LIMIT						!HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_12)							/* Iogr */
#define I_MAX						!HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_1)							/* Ipmax */
#define SUPPLY_24					!HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_3)							/* Power */
#define OVERLOAD					!HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_5)							/* Iper */
#define PHASE_BREAK					!HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_7)							/* Phase */
#define POLARITY					!HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_4)							/* Polarity */
